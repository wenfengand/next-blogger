      ...
      <li
        ...
        <div class="comments-info">
          ...
          <div class="name-time">
            <p class="name">
              {{ getName(comments) }}
              <span @click="reply(comments, comments.id)" v-if="!isAdminWrap">回复</span>
            </p>
          ...
          <li
            ...
            <div class="comments-info">
              ...
              <div class="name-time">
                <p class="name">
                  {{ getName(child) }}
                  <span @click="reply(child, comments.id)" v-if="!isAdminWrap">回复</span>
                </p>
...
export default {
  ...
  methods: {
    ...
    check() {
      ...
      this.captcha = new TencentCaptcha('2065011626', (res)=> {
        if(res.ret === 0){
          window.baidu({
            type: 'btn',
